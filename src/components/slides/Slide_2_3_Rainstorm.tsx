...
export default function Slide_2_3_Rainstorm() {
  // Animation variants
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-50 relative overflow-hidden font-sans">
      ...
      >
        ...
        {/* Right Column: Key Impacts & Consequences */}
            ...
            <div className="bg-red-800 rounded-2xl p-8 shadow-md relative overflow-hidden group hover:shadow-lg transition-all duration-300 hover:bg-red-900">
              ...
              <div className="flex items-center gap-6 relative z-10">
                <div className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center text-white border border-white/30 shrink-0">
                  <CloudRain className="w-10 h-10" strokeWidth={1.5} />
                </div>
                <div>
                  <h2 className="text-4xl font-extrabold text-white tracking-tight mb-2">Century Rainstorm</h2>
                  <p className="text-red-100 text-xl font-medium tracking-wide">Extreme Precipitation Event (Sept 2023)</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200 hover:shadow-md transition-shadow group flex items-start gap-6">
                <div className="w-12 h-12 bg-white rounded-full shadow-sm flex items-center justify-center shrink-0 border border-slate-100 group-hover:scale-110 transition-transform">
                  <Droplets className="w-6 h-6 text-slate-600 group-hover:text-red-800 transition-colors" />
                </div>
                <div>
                  <h4 className="text-xl font-bold text-slate-800 mb-3 group-hover:text-red-900 transition-colors">Record-Breaking Precipitation</h4>
                  <p className="text-slate-600 text-lg leading-relaxed font-medium">
                    Broke a <span className="font-bold text-red-800">140-year record</span> with an hourly rainfall of <span className="font-bold text-slate-900 whitespace-nowrap">158.1 mm</span>.
                  </p>
                </div>
              </div>
