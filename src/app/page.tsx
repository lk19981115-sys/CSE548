...
import Slide_5_1_MarketShifts_Updated from "@/components/slides/Slide_5_1_MarketShifts_Updated";
import Slide_5_2_TechnologyTransition_Updated from "@/components/slides/Slide_5_2_TechnologyTransition_Updated";
import Slide_5_3_ReputationalRisk_Updated from "@/components/slides/Slide_5_3_ReputationalRisk_Updated";
...
export default function Home() {
  const slides = [
    ...
    <Slide_5_1_MarketShifts_Updated key="chap5-1-updated" />,
    <Slide_5_2_TechnologyTransition_Updated key="chap5-2-updated" />,
    <Slide_5_3_ReputationalRisk_Updated key="chap5-3-updated" />,
